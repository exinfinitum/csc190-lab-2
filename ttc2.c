...
// Note: Begins leaking memory at sim_time >= 117. Below this time no memory leaks occur.
...
int main()
{
	...
	int SIM_TIME;
	int DEBUGGING;
	printf("Debugging? 1 for yes, any other char for no. ");
	scanf("%d", &DEBUGGING);
	printf("\nEnter a time: ");
	scanf("%d", &SIM_TIME);
	printf("\nBeginning simulation. Please wait.\n\n");
